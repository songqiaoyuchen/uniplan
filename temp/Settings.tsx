...
import { verticalViewToggled, specialTermsToggled } from "@/store/timetableSlice";

const Settings: React.FC = () => {
    const dispatch = useAppDispatch();
    const { isVerticalView, useSpecialTerms } = useAppSelector((state: any) => state.timetable);
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
            ...
            >
                <ToggleButton value="vertical" aria-label="vertical layout" sx={{ flex: 1 }}>
                    <ViewColumnIcon sx={{ mr: 1 }} />
                    Vertical
                </ToggleButton>
                <ToggleButton value="horizontal" aria-label="horizontal layout" sx={{ flex: 1 }}>
            ...
            <Box>
                ...
                <Typography variant="caption" color="text.secondary">
                    Configure how the scheduler generates your plan
                </Typography>
            </Box>
